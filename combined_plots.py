...
def plot_comparison(x, y1, y2, x_label, y_label, title):
    ...
    ax.plot(x, y1, marker='o', markersize=8, linewidth=3, color='#1f77b4', label='Simple VCRS', zorder=3)
    ax.plot(x, y2, marker='s', markersize=8, linewidth=3, color='#ff7f0e', label='Ejector VCRS', zorder=3)
...
plot_comparison(T_evap_array, EDR_sys_vcrs_1, EDR_sys_ej_1, 
                'Evaporator Temperature (K)', 'System Exergy Destruction Ratio (EDR)', 
                'System EDR vs Evaporator Temperature')

# 2. System EDR vs Gas Cooler Exit Temperature
plot_comparison(T_cond_array, EDR_sys_vcrs_2, EDR_sys_ej_2, 
                'Gas Cooler Exit Temp (K)', 'System Exergy Destruction Ratio (EDR)', 
                'System EDR vs Gas Cooler Exit Temp')
...
plot_comparison(T_evap_array, Ex_eff_vcrs_1, Ex_eff_ej_1, 
                ...
                'Exergetic Efficiency vs Evaporator Temperature')

# 4. Exergetic Efficiency vs Gas Cooler Exit Temperature
plot_comparison(T_cond_array, Ex_eff_vcrs_2, Ex_eff_ej_2, 
                'Gas Cooler Exit Temp (K)', 'Exergetic Efficiency (%)', 
                'Exergetic Efficiency vs Gas Cooler Exit Temp')